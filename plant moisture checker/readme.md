...
| - | - |
| [Capacitive Soil Moisture Sensor v1.2](https://www.amazon.de/dp/B07FLR13FS?ref=ppx_yo2ov_dt_b_fed_asin_title) | comes with a scan range between 20 - 120* |
...
>   *Depends on the used micro controller. Since an Arduino is in use, the scan range lies between `[20..120]` whereas an ESP32 comes with a scan range between `[400..2,200]`.
